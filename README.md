...
Este script Python encontra-se em fase de pré-lançamento, sendo apenas um estudo de caso. Foi desenvolvido para enviar automaticamente arquivos XML e PDF por e-mail.
...
- Enviar arquivos XML e PDF para clientes com base em dados encontrados no arquivo XML
...
Os arquivos XML e PDF serão enviados por e-mail para o endereço de e-mail padrão, quando aplicável, para os clientes com base nos dados encontrados no XML. Além disso, os arquivos enviados serão movidos para as pastas "enviados" e "enviados_cliente", conforme apropriado.
...
5. Loop principal: O programa entra em um loop infinito que verifica periodicamente se existem arquivos XML no diretório especificado. Se houver, realiza as seguintes etapas:
    ...
    * Analisa o arquivo XML: O programa abre o arquivo XML, lida com o namespace e busca por elementos específicos dentro do XML.
